...
QUnit.test('+ PUBLIC (setter / getter)', function(assert){
...
QUnit.test('+ PUBLIC (swap properties and values)', function(assert){
...
QUnit.test('+ PUBLIC (mapping implimentation)', function(assert){
...
QUnit.test('- PRIVATE (single object mapping)', function(assert){
...
QUnit.test('- PRIVATE (array object mapping)', function(assert){
